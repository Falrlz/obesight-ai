...
export const Footer: React.FC<FooterProps> = ({
  ...
  return (
    <footer className="w-full flex flex-col justify-between bg-surface-container-lowest pt-24 border-t border-outline-variant/30 print:hidden">
      <div className="max-w-container-max mx-auto px-4 md:px-page-margin-desktop w-full">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-20">
          {/* Logo & Info */}
          <div className="flex flex-col gap-6 items-center md:items-start">
            <h5 className="font-headline-lg text-3xl font-bold text-on-surface">OBESIGHT</h5>
          ...
          <div className="text-center md:text-left">
            <h5 className="font-headline-lg text-3xl font-bold text-on-surface mb-6">NAVIGASI</h5>
            <ul className="space-y-4 font-normal">
              <li>
                <button
                  onClick={onNavigateHome}
                  className="font-body-md text-on-surface-variant hover:text-secondary leading-relaxed transition-colors cursor-pointer"
                >
                  Beranda
                </button>
              </li>
          ...
          <div className="text-center md:text-left md:col-span-2">
            <h5 className="font-headline-lg text-3xl font-bold text-on-surface mb-6 text-center md:text-left">
              MEDICAL DISCLAIMER
            </h5>
            <p className="font-body-md text-on-surface-variant leading-relaxed text-left md:text-justify">
